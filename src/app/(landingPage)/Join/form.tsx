        ...
        <>
          ...
          >
            ...
            <div className={styles['actions']}>
              <input id="email" name="email" type="text" minLength={6} placeholder="example@mail.com" required={true} />
              ...
              <div className={styles['button-wrapper']}>
                <SubmitButton
                  ...
                  formId="JoinForm"
                  label="Submit"
                  style={{ backgroundColor: 'var(--bg-color-white)', color: 'var(--primary-color)' }}
                />
              </div>
            </div>
          </form>

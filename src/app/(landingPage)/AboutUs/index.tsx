	...
	return (
		<section id="aboutus" className={styles["layout"]}>
			...
			<p>
				...
				<br />
				<br />
				All skills sets are welcomed. Anyone with a desire to learn React, have
				questions about developing React, deploying top production, general
				JavaScript questions, setting up Webpack or whatever are welcome. If you
				want to make a presentation (short: 15 min / long: 30 min) get in
				contact! Bring a Laptop, and remember, be NICE!
			</p>

			<ul className={styles["host-list"]}>
				<li>
					<div className={styles["background-image"]}></div>
					<h3 className={styles.position}>Han Solo</h3>
				...
				<li>
					<div className={styles["background-image"]}></div>
					<h3 className={styles.position}>Chewbacca</h3>
					<span className={styles["border-line"]} />
					<p>
						Lorem, ipsum dolor sit amet consectetur adipisicing elit. Vero
						distinctio in sit culpa consequatur ratione, rem veritatis debitis

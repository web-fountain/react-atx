  ...
  return (
    <section className={styles.speakers}>
      <div className={styles.speakerContainer}>
        ...
        <form className={styles.speakerForm}>
          <div className={styles.speakerFormInputs}>
          ...
          <div className={styles.speakerFormChecks}>
            <div className={styles.speakerFormCheck}>
            ...
            <div className={styles.speakerFormCheck}>
              ...
              <p>
                Step by step instructions with credible references that link
                back to best practices, using some live code or photos of your
